...
void Error::setSymbolIndex(int symbolIndex) {
...
QString Error::message() const {
    ...
    case Type::noLeftOperand:
        return "Отсутствует левый операнд у операции \"" + operation + "\" на позиции " + QString::number(symbolIndex);
    case Type::noRightOperand:
        return "Отсутствует правый операнд у операции \"" + operation + "\" на позиции " + QString::number(symbolIndex);
    case Type::noBothOperands:
        return "Отсутствуют операнды у операции \"" + operation + "\" на позиции " + QString::number(symbolIndex);
    case Type::noClosingParenthesis:
        return "Отсутствует закрывающая скобка к открывающей на позиции " + QString::number(symbolIndex);
    case Type::noOpeningParenthesis:
        return "Отсутствует открывающая скобка к закрывающей на позиции " + QString::number(symbolIndex);
